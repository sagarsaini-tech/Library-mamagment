...
export const OwnerLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'Students', path: '/owner/students', icon: <Users className="w-5 h-5 mr-3" /> },
    { name: 'Seats', path: '/owner/seats', icon: <UserSquare2 className="w-5 h-5 mr-3" /> },
    { name: 'Fee Management', path: '/owner/fees', icon: <Receipt className="w-5 h-5 mr-3" /> },
    { name: 'Expenses', path: '/owner/expenses', icon: <Wallet className="w-5 h-5 mr-3" /> },
    { name: 'Attendance', path: '/owner/attendance', icon: <CalendarCheck className="w-5 h-5 mr-3" /> },
    { name: 'Reports', path: '/owner/reports', icon: <FileBarChart className="w-5 h-5 mr-3" /> },
    { name: 'Notice Board', path: '/owner/notices', icon: <Bell className="w-5 h-5 mr-3" /> },
    { name: 'Staff Management', path: '/owner/staff', icon: <Users className="w-5 h-5 mr-3" /> },
    { name: 'Settings', path: '/owner/settings', icon: <Settings className="w-5 h-5 mr-3" /> },
  ];
